        ...
        <div className="container-login text-center">
            ...
            <form method="post" onSubmit={handleSubmit}>
                ...
                <div className="form-floating mb-4">
                    ...
                    {usernameError && <div id="usernameError" className="form-text text-danger">{usernameError}</div>}
                </div>
                ...
                <div className="form-floating mb-4">
                    ...
                    {passwordError && <div id="passwordError" className="form-text text-danger">{passwordError}</div>}
                </div>
                ...
                <div className="row mb-4">
                    <div className="col d-flex justify-content-center">
                        ...
                        <div className="form-check">
                            <input className="form-check-input" type="checkbox" value="True" id="chkRecuerdame" name="chkRecuerdame"/>
                ...
                {/* Mensaje de error */}
                {textError && <div id="error" className="form-text text-danger text-center mb-2">{textError}</div>}
